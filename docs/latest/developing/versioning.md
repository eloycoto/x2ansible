...
- [ ] Copy versioned data files under `docs/_data/` (for example, `cp docs/_data/rhdh-plugins-latest.json docs/_data/rhdh-plugins-v0.6.json`) and update the copied pages' `version_data` values.
